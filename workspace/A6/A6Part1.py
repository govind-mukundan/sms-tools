...
def estimateF0(inputFile = '../../sounds/cello-double-2.wav'):
    ...
    ### Change these analysis parameter values v2Y4QwrkZY
    window = 'blackman'
    M = 4096 * 4 - 999
    N = 4096 * 4
    f0et = 5
...
if __name__ == "__main__":
    ...
    # Running gui tool :
    # cd MOOC/DSP-Audio-14/sms-tools/software/models_interface/
    # /usr/bin/python2.7 models_GUI.py